defmodule ExpenseTracker.Expenses.Payment do
  ...
  def changeset(payment, attrs) do
    payment
    |> cast(attrs, [:item_name, :category, :purchase_date, :purchase_time, :amount, :payment_type])
    |> validate_required([:item_name, :category, :purchase_date, :purchase_time, :amount, :payment_type])
  end
end
